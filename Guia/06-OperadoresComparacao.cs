...
namespace CursoCSharp.Guia
{
    public class OperadoresComparacao
    {
        public static void DemonstrarOperadores()
        {
            ...
            Console.WriteLine($"a >= b: {maiorOuIgual}"); //False, porque 10 não é maior ou igual que 20

            // Menor ou igual a (<=)
            bool menorOuIgual = (a <= b);
            Console.WriteLine($"a <= b: {menorOuIgual}"); //True, porque 10 é menor ou igual que 20
